...
pub fn map_long_box_ramp_2_collider() -> ComplexCollider {
    let map_long_box_ramp_2_convex_hull_0: ConvexHullCollider = ConvexHullCollider { vertices_local: MAP_LONG_BOX_RAMP_2_CONVEX_HULL0_VERTICES.to_vec(), triangle_indices_local: MAP_LONG_BOX_RAMP_2_CONVEX_HULL0_TRIANGLE_INDICES_LOCAL.to_vec(), margin: 0.0, collider_type: ConvexHullColliderType::None };
