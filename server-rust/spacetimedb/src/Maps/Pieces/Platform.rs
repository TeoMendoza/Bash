...
pub fn platform_collider() -> ComplexCollider {
    let platform_convex_hull_0: ConvexHullCollider = create_convex_hull_collider(PLATFORM_CONVEX_HULL0_VERTICES, PLATFORM_CONVEX_HULL0_TRIANGLE_INDICES_LOCAL, 0.0, ConvexHullColliderType::None);
