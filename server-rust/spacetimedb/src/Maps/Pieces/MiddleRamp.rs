...
pub fn middle_ramp_collider() -> ComplexCollider {
    let middle_ramp_convex_hull_0: ConvexHullCollider = create_convex_hull_collider(MIDDLE_RAMP_CONVEX_HULL0_VERTICES, MIDDLE_RAMP_CONVEX_HULL0_TRIANGLE_INDICES_LOCAL, 0.0, ConvexHullColliderType::None);
