...
pub static MAP_BOX_EDGE_2_JUMP_1_CONVEX_HULL0_VERTICES: &[DbVector3] = &[
...
pub static MAP_BOX_EDGE_2_JUMP_1_CONVEX_HULL0_TRIANGLE_INDICES_LOCAL: &[i32] = &[
    0,
    1,
    2,
    5,
...
pub fn map_box_edge_2_jump_1_collider() -> ComplexCollider {
    let map_box_edge_2_jump_1_convex_hull_0: ConvexHullCollider = ConvexHullCollider { vertices_local: MAP_BOX_EDGE_2_JUMP_1_CONVEX_HULL0_VERTICES.to_vec(), triangle_indices_local: MAP_BOX_EDGE_2_JUMP_1_CONVEX_HULL0_TRIANGLE_INDICES_LOCAL.to_vec(), margin: 0.0 };
