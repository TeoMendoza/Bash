...
namespace SpacetimeDB.Types
{
    ...
    {
        public sealed class MyMatchPlayersHandle : RemoteTableHandle<EventContext, Magician>
        {
            protected override string RemoteTableName => "my_match_players";

            internal MyMatchPlayersHandle(DbConnection conn) : base(conn)
            {
            }
        ...
        public readonly MyMatchPlayersHandle MyMatchPlayers;
    }

    public sealed class MyMatchPlayersCols
    {
        ...
        public MyMatchPlayersCols(string tableName)
        {
    ...
    public sealed class MyMatchPlayersIxCols
    {
        public global::SpacetimeDB.IxCol<Magician, SpacetimeDB.Identity> Identity { get; }

        public MyMatchPlayersIxCols(string tableName)
        {
