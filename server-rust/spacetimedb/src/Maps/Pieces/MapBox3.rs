...
pub fn map_box_3_collider() -> ComplexCollider {
    let map_box_3_convex_hull_0: ConvexHullCollider = ConvexHullCollider { vertices_local: MAP_BOX_3_CONVEX_HULL0_VERTICES.to_vec(), triangle_indices_local: MAP_BOX_3_CONVEX_HULL0_TRIANGLE_INDICES_LOCAL.to_vec(), margin: 0.0, collider_type: ConvexHullColliderType::None };
