...
pub fn middle_ramp_2_collider() -> ComplexCollider {
    let middle_ramp_2_convex_hull_0: ConvexHullCollider = ConvexHullCollider { vertices_local: MIDDLE_RAMP_2_CONVEX_HULL0_VERTICES.to_vec(), triangle_indices_local: MIDDLE_RAMP_2_CONVEX_HULL0_TRIANGLE_INDICES_LOCAL.to_vec(), margin: 0.0, collider_type: ConvexHullColliderType::None };
