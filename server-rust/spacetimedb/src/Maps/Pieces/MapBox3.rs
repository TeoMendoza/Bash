...
pub fn map_box_3_collider() -> ComplexCollider {
    let map_box_3_convex_hull_0: ConvexHullCollider = create_convex_hull_collider(MAP_BOX_3_CONVEX_HULL0_VERTICES, MAP_BOX_3_CONVEX_HULL0_TRIANGLE_INDICES_LOCAL, 0.0, ConvexHullColliderType::None);
