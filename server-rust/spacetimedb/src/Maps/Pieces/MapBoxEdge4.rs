...
pub fn map_box_edge_4_collider() -> ComplexCollider {
    let map_box_edge_4_convex_hull_0: ConvexHullCollider = ConvexHullCollider { vertices_local: MAP_BOX_EDGE_4_CONVEX_HULL0_VERTICES.to_vec(), triangle_indices_local: MAP_BOX_EDGE_4_CONVEX_HULL0_TRIANGLE_INDICES_LOCAL.to_vec(), margin: 0.0 };
