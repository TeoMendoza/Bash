...
pub fn map_long_box_ramp_2_collider() -> ComplexCollider {
    let map_long_box_ramp_2_convex_hull_0: ConvexHullCollider = create_convex_hull_collider(MAP_LONG_BOX_RAMP_2_CONVEX_HULL0_VERTICES, MAP_LONG_BOX_RAMP_2_CONVEX_HULL0_TRIANGLE_INDICES_LOCAL, 0.0, ConvexHullColliderType::None);
